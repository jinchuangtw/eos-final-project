...
#pragma endregion
	...
	private: System::Void connect_btn_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		if (UART_Status == 0)
		{
			...
			{
				showmessage->AppendText("Can not open comport ...\r");
			}
			else
			{
				UART_Status = 1;
	...
	private: System::Void timer1_Tick(System::Object^ sender, System::EventArgs^ e)
	{
		...
		if (UART_Status == 1)
		{
			...
			if (UART_IsUpdated == 1)
			{ 
				roll_box->Text = (Convert::ToString((double)((int)(UART.RxData.Value[0] * 100) / 100.0)));
				pitch_box->Text = (Convert::ToString((double)((int)(UART.RxData.Value[1] * 100) / 100.0)));
				yaw_box->Text = (Convert::ToString((double)((int)((UART.RxData.Value[2]-YAW_OFFSET_DEG) * 100) / 100.0)));
