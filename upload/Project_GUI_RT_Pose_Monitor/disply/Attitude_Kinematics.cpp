...
{
    double q0, q1, q2, q3;
    double q0q1, q2q3, q1q1, q0q2, q1q3, q0q3, q1q2, q2q2, q3q3;
    ...
    eul[0] = atan2(2.0 * (q0q1 + q2q3), 1.0 - 2.0 * (q1q1 + q2q2));
    eul[1] = asin(2.0 * (q0q2 - q1q3));
    eul[2] = atan2(2.0 * (q0q3 + q1q2), 1.0 - 2.0 * (q2q2 + q3q3));
}
