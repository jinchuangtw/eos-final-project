...
//            HAL_UART_Transmit(&huart2, (uint8_t*) (&start_byte), 1, HAL_MAX_DELAY);
//            for (int i = 0; i < 3; i++)
//            {
//                HAL_UART_Transmit(&huart2, (uint8_t*) (&eul[i]), sizeof(double), HAL_MAX_DELAY);
//            }
//            HAL_UART_Transmit(&huart2, (uint8_t*) (&finish_byte), 1, HAL_MAX_DELAY);
...
int main(void)
{
    ...
    double s_acc[3] = {1.0, 1.0, 1.0};
    double b_acc[3] = {0.0, 0.0, 0.0};
    double s_mag[3] = {1.0, 1.0, 1.0};
    double b_mag[3] = {0.0, 0.0, 0.0};
    ...
    {
        MPU_I2C_Read(&IMU);
        HAL_Delay(pdMS_TO_TICKS(AHRS_TIME_MS));
    ...
    xTaskCreate(vTask_AHRS, "AHRS", 1000, NULL, 1, NULL);
